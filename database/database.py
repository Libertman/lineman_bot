...
deadlines = {'Физическая культура':
             ...
             'Английский язык':
             [Deadline(name='Тест по модулю 1', deadline=datetime(2024, 10, 8)),
              Deadline(name='Монолог по модулю 1 "Personality"', deadline=datetime(2024, 10, 15), reminder=[21600, 86400, 604800])]}
