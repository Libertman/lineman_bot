...
deadlines = {'Физическая культура':
             [Deadline(name='Аттестация по модулю: Основы теории физической культуры', deadline=datetime(2024, 10, 3, 1, 35), subject='Физическая культура'),
              Deadline(name='Аттестация по модулю: Медико-биологические основы физической культуры', deadline=datetime(2024, 10, 3, 1, 35, 30), subject='Физическая культура'),
              Deadline(name='Аттестация по модулю: Самостоятельные занятия физическими упражнениями', deadline=datetime(2024, 10, 3, 1, 36), subject='Физическая культура'),
              Deadline(name='Аттестация по модулю: Физическая культура в профессиональной деятельности специалиста', deadline=datetime(2024, 10, 3, 1, 36, 30), subject=''),
              Deadline(name='Аттестация по модулю: Спорт как социальное явление', deadline=datetime(2024, 10, 3, 1, 37), subject='Физическая культура'),
              Deadline(name='Аттестация по модулю: Физическая культура при различных заболеваниях', deadline=datetime(2024, 10, 3, 1, 37, 30), subject='Физическая культура'),
              Deadline(name='Промежуточная аттестация', deadline=datetime(2024, 11, 15), subject='Физическая культура'),
              Deadline(name='Итоговый тест с прокторингом', deadline=datetime(2024, 11, 30), subject='Физическая культура')],
             'Экономическая культура':
             [Deadline(name='Основные экономические категории', deadline=datetime(2024, 9, 22), subject='Экономическая культура'),
