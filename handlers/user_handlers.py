...
from keyboards.keyboards import functions_keyboard, help_start_keyboard, subjects_keyboard
...
async def process_pe_subject(message: Message):
    ...
    await message.answer(LEXICON_RU['pe_description'].format(all_deadlines), reply_markup=functions_keyboard)
...
async def process_economics_subject(message: Message):
    ...
    await message.answer(LEXICON_RU['economics_description'].format(all_deadlines), reply_markup=functions_keyboard)
...
async def process_digital_subject(message: Message):
    ...
    await message.answer(LEXICON_RU['digital_description'].format(all_deadlines), reply_markup=functions_keyboard)
...
async def process_english_subject(message: Message):
    ...
    await message.answer(LEXICON_RU['english_description'].format(all_deadlines), reply_markup=functions_keyboard)
...
async def process_russia_subject(message: Message):
    ...
    await message.answer(LEXICON_RU['Россия: государственное основание и мировоззрение'].format(all_deadlines), reply_markup=functions_keyboard)
